...
namespace Molinos.DataAgro.Repository.ConsultasEF
{
    public class TraerToneladasPorGrano : IConsultaEscalar<ToneladasGranoTipoDto>
    {
        ...
        public ToneladasGranoTipoDto Ejecutar(DbContext contexto)
        {
            ...
            toneladasPorGrano.DispAFijar =Math.Round( posicion.Where(x => x.TipoNegocioId == 1 && (x.MaterialCampanaId > x.CampanaId || (x.MaterialCampanaId == x.CampanaId && fechaPosicion >= x.Posicion))).Sum(y => y.Cantidad/1000));
            toneladasPorGrano.DispAPrecio = Math.Round(posicion.Where(x => x.TipoNegocioId == 2 && (x.MaterialCampanaId > x.CampanaId || (x.MaterialCampanaId == x.CampanaId && fechaPosicion >= x.Posicion))).Select(y => y.Cantidad/1000).DefaultIfEmpty(0).Sum());
            toneladasPorGrano.FrwAFijar = Math.Round(posicion.Where(x => x.TipoNegocioId == 1 && x.MaterialCampanaId == x.CampanaId && fechaPosicion < x.Posicion).Select(y => y.Cantidad / 1000).DefaultIfEmpty(0).Sum());
            toneladasPorGrano.FrwAPrecio = Math.Round(posicion.Where(x => x.TipoNegocioId == 2 && x.MaterialCampanaId == x.CampanaId && fechaPosicion < x.Posicion).Select(y => y.Cantidad / 1000).DefaultIfEmpty(0).Sum());
            toneladasPorGrano.NewAFijar = Math.Round(posicion.Where(x => x.TipoNegocioId == 1 && x.MaterialCampanaId < x.CampanaId).Select(y => y.Cantidad / 1000).DefaultIfEmpty(0).Sum());
            ...
            toneladasPorGrano.DispFijac = Math.Round(fijaciones.Where(x => x.MaterialCampanaId > x.CampanaId || (x.MaterialCampanaId == x.CampanaId && fechaPosicion >= x.Posicion)).Select(y => y.Cantidad / 1000).DefaultIfEmpty(0).Sum());
            ...
            toneladasPorGrano.DispFason = Math.Round(fason.Where(x => x.MaterialCampanaId > x.CampanaId||( x.MaterialCampanaId == x.CampanaId && fechaPosicion >= x.Posicion)).Select(y => y.Cantidad / 1000).DefaultIfEmpty(0).Sum());
