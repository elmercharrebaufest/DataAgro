            ...
            if (!PermisosHelper.Is(PermisosDataAgro.IngresoExterno))
            {
                ...
                var queryFijacion =
                    ...
                    select new BasicoContrato()
                    {
                        ...
                        ComercialZonaId = fijac.Comercial.GrupoDeComprasId,
                        ComercialZonaDescripcion = fijac.Comercial.GrupoDeCompras.Descripcion ,
                ...
                if (PermisosHelper.Is(PermisosDataAgro.CrearNegociosFason))
                {
                    var queryFason =
                        ...
                        select new BasicoContrato()
                        {
                            ...
                            ComercialZonaId = fas.Comercial.GrupoDeComprasId,
                            ComercialZonaDescripcion = fas.Comercial.GrupoDeCompras.Descripcion,
                            ...
                            Cuit = fas.Fasonero.CUIT == null ? "" : fas.Fasonero.CUIT,
                ...
                if (PermisosHelper.Is(PermisosDataAgro.CrearNegociosAgente))
                {
                    var queryAgente =
                        ...
                        select new BasicoContrato()
                        {
                            ...
                            ComercialZonaId = age.Comercial.GrupoDeComprasId,
                            ComercialZonaDescripcion = age.Comercial.GrupoDeCompras.Descripcion,
                            ...
                            Campania = age.Campana.Descripcion,
                            Provincia = "",
                ...
                if (PermisosHelper.Is(PermisosDataAgro.CrearNegociosAcuerdos))
                {
                    var queryAcuerdo =
                        ...
                        select new BasicoContrato()
                        {
                            ...
                            ComercialZonaId = acu.Comercial.GrupoDeComprasId,
                            ComercialZonaDescripcion = acu.Comercial.GrupoDeCompras.Descripcion,
                            ...
                            AgenteId = 0,
                            PrecioNeto = null,
                            StandardCalidadId = acu.StandardDeCalidadId,
                            StandardDeCalidadDescripcion = acu.StandardDeCalidad!= null ? acu.StandardDeCalidad.Descripcion:null,
                            Pizarra = null,
                            PagoDiferido = null,
                            ZonaId = null,
                            ZonaDescripcion = "",
            ...
            else
            {
                ...
                var queryFijacion =
                    ...
                    select new BasicoContrato()
                    {
                        ...
                        Dias_Pesificado = fijac.DiasPesificado,
                        NoInformaSIO = null,
                        Estado = fijac.EstadoId != 9 && fijac.EstadoId != 5 ? fijac.EstadoId == 6 || fijac.EstadoId == 8 ? 6 : 2 : fijac.EstadoId,
                        Estado_Contrato = fijac.EstadoId != 9 ? fijac.EstadoId == 6 || fijac.EstadoId == 8 ? "Rechazado" : "Confirmado" : "Carga",
                        Estado_Order = fijac.Estado.Orden,
                        UsuarioId = "",
                        ContratoSAP = fijac.ContratoSAP,
                        Ampliaciones = fijac.Ampliaciones,
