            ...
            else
            {
                ...
                var queryFijacion =
                    ...
                    select new BasicoContrato()
                    {
                        ...
                        Dias_Pesificado = fijac.DiasPesificado,
                        NoInformaSIO = null,
                        Estado = fijac.EstadoId != 9 ? fijac.EstadoId == 6 || fijac.EstadoId == 8 ? 6 : 2 : 9,
                        Estado_Contrato = fijac.EstadoId != 9 ? fijac.EstadoId == 6 || fijac.EstadoId == 8 ? "Rechazado" : "Confirmado" : "PreAprobacion",
                        Estado_Order = fijac.Estado.Orden,
                        UsuarioId = "",
                        ContratoSAP = fijac.ContratoSAP,
                        Ampliaciones = fijac.Ampliaciones,
