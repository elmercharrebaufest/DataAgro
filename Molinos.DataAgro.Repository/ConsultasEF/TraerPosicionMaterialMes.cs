        ...
        private static List<ExcelPosicionMaterialDto> Query(DbContext contexto, DateTime fechaDesde, DateTime fechaHasta, bool verFijaciones = true)
        {
            ...
            && !(((x is FijacionDePrecioContrato) && (x as FijacionDePrecioContrato).Canje != true && (x as FijacionDePrecioContrato).Virtual != true && (x as FijacionDePrecioContrato).Contrato.Canje == true))
                       ...
                       .OrderBy(x => SqlFunctions.DatePart("month", x.Fecha)).Select(x => new ExcelPosicionMaterialDto
                       {
                           ...
                           Material = x.MaterialId == 1 ? "Maiz" : x.MaterialId == 2 ? "Trigo" : x.MaterialId == 3 ? "Soja" : x.MaterialId == 4 ? "Girasol" : x.MaterialId == 5 ? "Girasol Alto Oleico" : x.MaterialId == 6 ? "Sorgo" : "",
                           ...
                           MercaderiaEnDeposito = x.MercsDeposito == true ? "X" : "",
