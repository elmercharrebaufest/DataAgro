...
namespace Molinos.DataAgro.Report
{
    ...
    public partial class RptCamposSustentables : DataDynamics.ActiveReports.ActiveReport
    {
        //--------------------------------------------------------------------------------
        //  Constructor
        //--------------------------------------------------------------------------------
        
        public List<CamposSustentableReporte> Campos = new List<CamposSustentableReporte>();
     

        public RptCamposSustentables()
        {
            //
        ...
        {           
            this.SubRptCamposSustentables.Report = new SubRptCamposSustentables();
            SubRptCamposSustentables.Report.DataSource = this.Campos;
