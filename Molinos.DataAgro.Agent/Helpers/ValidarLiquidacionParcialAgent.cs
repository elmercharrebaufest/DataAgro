...
namespace Molinos.DataAgro.Agent.Helpers
{
    public class ValidarLiquidacionParcialAgent : IValidarLiquidacionParcialAgent
    {
        ...
        public ValidarLiquidacionParcialAgent(ILogger logger, IRepositorio repositorio, IContratosParaFijacionAgent contratosParaFijacionAgent, ITipoDeCambioAgent tipoCambioAgent)
        {
            this.logger = logger;
