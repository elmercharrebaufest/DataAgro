...
{
    public class ProcesadorClausulaGenericosVeinteYNueve : ProcesadorClausulaGenericos<ClausulaGenericosVeinteYNueve>
    {
        public ProcesadorClausulaGenericosVeinteYNueve(IRepositorio repositorio, ILogger log, IConsultarEstadoBoletoAgent estadoBoleto)
            : base(repositorio, log, estadoBoleto) { }

        public override ResultadoClausula DevolverClausulas(ClausulaGenericosVeinteYNueve clausula)
        {
