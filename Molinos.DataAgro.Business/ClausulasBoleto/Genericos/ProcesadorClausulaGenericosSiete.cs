...
{
    public class ProcesadorClausulaGenericosSiete : ProcesadorClausulaGenericos<ClausulaGenericosSiete>
    {
        public ProcesadorClausulaGenericosSiete(IRepositorio repositorio, ILogger log, IConsultarEstadoBoletoAgent estadoBoleto)
            : base(repositorio, log, estadoBoleto) { }

        public override ResultadoClausula DevolverClausulas(ClausulaGenericosSiete clausula)
        {
            var res = new ResultadoClausula();
            if (clausula.Basico.MaterialId == (int)EnumMateriales.SOJA && clausula.Basico.BoletoId != (int)EnumBoletoCompraNet.FISICO)
            {
