...
{
    public class ProcesadorClausulaCartaOfertaNueve : ProcesadorClausulaCartaOferta<ClausulaCartaOfertaNueve>
    {
        public ProcesadorClausulaCartaOfertaNueve(IRepositorio repositorio, ILogger log, IConsultarEstadoBoletoAgent estadoBoleto)
