...
{
    public class ProcesadorClausulaCartaOfertaOcho : ProcesadorClausulaCartaOferta<ClausulaCartaOfertaOcho>
    {
        public ProcesadorClausulaCartaOfertaOcho(IRepositorio repositorio, ILogger log, IConsultarEstadoBoletoAgent estadoBoleto)
            : base(repositorio, log, estadoBoleto) { }

        public override ResultadoClausula DevolverClausulas(ClausulaCartaOfertaOcho clausula)
        {
