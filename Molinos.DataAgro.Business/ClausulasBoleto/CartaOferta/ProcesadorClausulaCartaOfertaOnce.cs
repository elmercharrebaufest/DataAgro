...
{
    public class ProcesadorClausulaCartaOfertaOnce : ProcesadorClausulaCartaOferta<ClausulaCartaOfertaOnce>
    {
        public ProcesadorClausulaCartaOfertaOnce(IRepositorio repositorio, ILogger log, IConsultarEstadoBoletoAgent estadoBoleto)
            : base(repositorio, log, estadoBoleto) { }

        public override ResultadoClausula DevolverClausulas(ClausulaCartaOfertaOnce clausula)
        {
