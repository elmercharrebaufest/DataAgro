...
{
    public class ProcesadorClausulaCartaOfertaTres : ProcesadorClausulaCartaOferta<ClausulaCartaOfertaTres>
    {
        public ProcesadorClausulaCartaOfertaTres(IRepositorio repositorio, ILogger log, IConsultarEstadoBoletoAgent estadoBoleto)
            : base(repositorio, log, estadoBoleto) { }

        public override ResultadoClausula DevolverClausulas(ClausulaCartaOfertaTres clausula)
        {
