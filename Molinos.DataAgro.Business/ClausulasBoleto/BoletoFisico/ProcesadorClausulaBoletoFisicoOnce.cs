...
{
    public class ProcesadorClausulaBoletoFisicoOnce : ProcesadorClausulaBoletoFisico<ClausulaBoletoFisicoOnce>
    {
        public ProcesadorClausulaBoletoFisicoOnce(IRepositorio repositorio, ILogger log, IConsultarEstadoBoletoAgent estadoBoleto)
            : base(repositorio, log, estadoBoleto) { }

        public override ResultadoClausula DevolverClausulas(ClausulaBoletoFisicoOnce clausula)
        {
