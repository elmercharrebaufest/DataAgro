...
{
    public class ProcesadorClausulaBoletoFisicoCatorce : ProcesadorClausulaBoletoFisico<ClausulaBoletoFisicoCatorce>
    {
        public ProcesadorClausulaBoletoFisicoCatorce(IRepositorio repositorio, ILogger log, IConsultarEstadoBoletoAgent estadoBoleto)
            : base(repositorio, log, estadoBoleto) { }

        public override ResultadoClausula DevolverClausulas(ClausulaBoletoFisicoCatorce clausula)
        {
