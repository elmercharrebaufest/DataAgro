...
{
    public class ProcesadorClausulaOchentaYSiete : ProcesadorClausula<ClausulaOchentaYSiete>
    {
        public ProcesadorClausulaOchentaYSiete(IRepositorio repositorio, ILogger log, IConsultarEstadoBoletoAgent estadoBoleto)
           : base(repositorio, log, estadoBoleto)
        {

        }

        public override ResultadoClausula DevolverClausulas(ClausulaOchentaYSiete clausula)
        {
