...
{
    public class ProcesadorClausulaSetentaYTres : ProcesadorClausula<ClausulaSetentaYTres>
    {
        public ProcesadorClausulaSetentaYTres(IRepositorio repositorio, ILogger log, IConsultarEstadoBoletoAgent estadoBoleto) : base(repositorio, log, estadoBoleto)
        {
        }
        public override ResultadoClausula DevolverClausulas(ClausulaSetentaYTres clausula)
        {
