...
namespace Molinos.DataAgro.Business.Procesamiento
{
    public class ProcesadorClausulaCincuentaYUno : ProcesadorClausula<ClausulaCincuentaYUno>
    {
        ...
        public override ResultadoClausula DevolverClausulas(ClausulaCincuentaYUno clausula)
        {
            ...
            if (clausula.Basico.MaterialId == (int)EnumMateriales.SOJA && (bool)clausula.Basico.Sustentable && clausula.Basico.MonedaId_Sustentable.Equals("USDM ") && clausula.Basico.SustentableTipoDBId == (int)EnumTipoDB.POR_FUERA_DEL_PRECIO && clausula.Basico.TarifaAConvenir != true)
            {
            ...
            else if (clausula.Basico.MaterialId == (int)EnumMateriales.SOJA && (bool)clausula.Basico.Sustentable && clausula.Basico.MonedaId_Sustentable.Equals("ARP  ") && clausula.Basico.SustentableTipoDBId == (int)EnumTipoDB.POR_FUERA_DEL_PRECIO && clausula.Basico.TarifaAConvenir != true)
            {
            ...
            else if (clausula.Basico.MaterialId == (int)EnumMateriales.SOJA && ((bool)clausula.Basico.Sustentable || (bool)clausula.Basico.EPA) && clausula.Basico.Importe_Sustentable == null && clausula.Basico.TarifaAConvenir == true)
            {
            ...
            else if (clausula.Basico.MaterialId == (int)EnumMateriales.SOJA && (bool)clausula.Basico.EPA && clausula.Basico.MonedaId_Sustentable.Equals("ARP  ") && clausula.Basico.SustentableTipoDBId == (int)EnumTipoDB.POR_FUERA_DEL_PRECIO && clausula.Basico.TarifaAConvenir != true)
            {
            ...
            else if (clausula.Basico.MaterialId == (int)EnumMateriales.SOJA && (bool)clausula.Basico.EPA && clausula.Basico.Importe_Sustentable == null && clausula.Basico.TarifaAConvenir == true)
            {
