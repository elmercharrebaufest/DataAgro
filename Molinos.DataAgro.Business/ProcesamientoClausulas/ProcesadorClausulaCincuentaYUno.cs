...
namespace Molinos.DataAgro.Business.Procesamiento
{
    public class ProcesadorClausulaCincuentaYUno : ProcesadorClausula<ClausulaCincuentaYUno>
    {
        ...
        public override ResultadoClausula DevolverClausulas(ClausulaCincuentaYUno clausula)
        {
            ...
            {
                res.Texto += $" Las Partes establecen que, para el caso que al momento de la entrega se constate que la mercadería entregada" + "no cumple con los requisitos de soja SUSTENTABLE, el precio convenido será bonificado en la cantidad de USD " + $"{clausula.Basico.Importe_Sustentable}" + " (dólares estadounidenses " + $"{DevolverNumeroEnLetras((decimal)clausula.Basico.Importe_Sustentable)}" + ") por tonelada de soja no SUSTENTABLE, a favor del Comprador. " + "Dicha bonificación será descontada al momento del pago de cada una de las liquidaciones parciales y/o finales según " + "corresponda.”";
            }
            // EL MATERIAL ES SOJA Y ES SUSTENTABLE FUERA DE PRECIO EN ARP
            else if (clausula.Basico.MaterialId == (int)EnumMateriales.SOJA && (bool)clausula.Basico.Sustentable && clausula.Basico.MonedaId.Equals("ARP  ") && clausula.Basico.SustentableTipoDBId == (int)EnumTipoDB.POR_FUERA_DEL_PRECIO)
            {
                res.Texto += $" Las Partes establecen que, para el caso que al momento de la entrega se constate que la mercadería entregada" + "no cumple con los requisitos de soja SUSTENTABLE, el precio convenido será bonificado en la cantidad de $ " + $"{clausula.Basico.Importe_Sustentable}" + " (pesos " + $"{DevolverNumeroEnLetras((decimal)clausula.Basico.Importe_Sustentable)}" + ") por tonelada de soja no SUSTENTABLE, a favor del Comprador. " + "Dicha bonificación será descontada al momento del pago de cada una de las liquidaciones parciales y/o finales según " + "corresponda.”";
            }
            ...
            {
                res.Texto = $"Las Partes establecen que, para el caso que al momento de la entrega se constate que la mercadería entregada " + "no cumple con las especificaciones y certificaciones establecidas para la Soja Sustentable “EPA” (certificación de establecimiento " + "e indicación “EPA” en Observaciones de la Carta de Porte) y condiciones de entrega (fecha de entrega desde" + $"{clausula.Basico.FechaDesde}" + " hasta " + $"{clausula.Basico.FechaHasta}" + " y código de cupo), el precio será bonificado en la cantidad de USD " + $" {clausula.Basico.Monto}" + " (dólares estadounidenses " + $"{DevolverNumeroEnLetras((decimal)clausula.Basico.Monto)}" + ") por tonelada, a favor del Comprador. Dicha bonificación será descontada al momento del pago de cada una " + "de las liquidaciones parciales y/o finales según corresponda.";
            }
            ...
            {
                res.Texto = $"Las Partes establecen que, para el caso que al momento de la entrega se constate que la mercadería entregada " + "no cumple con las especificaciones y certificaciones establecidas para la Soja Sustentable “EPA” (certificación de establecimiento " + "e indicación “EPA” en Observaciones de la Carta de Porte) y condiciones de entrega (fecha de entrega desde" + $"{clausula.Basico.FechaDesde}" + " hasta " + $"{clausula.Basico.FechaHasta}" + " y código de cupo), el precio será bonificado en la cantidad de $ " + $" {clausula.Basico.ImporteSobrePrecioContrato}" + " (pesos " + $"{DevolverNumeroEnLetras((decimal)clausula.Basico.ImporteSobrePrecioContrato)}" + ") por tonelada, a favor del Comprador. Dicha bonificación será descontada al momento del pago de cada una " + "de las liquidaciones parciales y/o finales según corresponda.";
            }
            ...
            {
                res.Texto = $" Al precio se le adicionará la tarifa convenida de" + $" {clausula.Basico.Importe_Sustentable} " + "USDM por tonelada de soja sustentable “EPA” " + "(certificación de establecimiento e indicación “EPA” en Observaciones de la Carta de Porte) entregada, siempre cuando la " + "mercadería fijada haya sido entregada conforme los plazos de recibo pautados en el presente Boleto";
            }
            ...
            {
                res.Texto += $"Al precio se le adicionará la tarifa convenida de " + $"{clausula.Basico.Importe_Sustentable}" + " PESOS por tonelada de soja sustentable “EPA”" + "(certificación de establecimiento e indicación “EPA” en Observaciones de la Carta de Porte) entregada, siempre cuando la" + "mercadería fijada haya sido entregada conforme los plazos de recibo pautados en el presente Boleto.";
            }
