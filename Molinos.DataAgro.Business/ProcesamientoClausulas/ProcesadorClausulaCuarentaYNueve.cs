...
namespace Molinos.DataAgro.Business.Procesamiento
{
    public class ProcesadorClausulaCuarentaYNueve : ProcesadorClausula<ClausulaCuarentaYNueve>
    {
        ...
        public override ResultadoClausula DevolverClausulas(ClausulaCuarentaYNueve clausula)
        {
            ...
            else if ((clausula.Basico.MaterialId == (int)EnumMateriales.MAIZ || clausula.Basico.MaterialId == (int)EnumMateriales.TRIGO) && clausula.Basico.StandardCalidadId == (int)EnumStandarCalidad.ESPECIAL)
            {
