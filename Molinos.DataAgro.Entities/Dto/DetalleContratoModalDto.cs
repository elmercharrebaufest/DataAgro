...
{
    public class DetalleContratoModalDto : ICloneable
    {
        ...
        public string FechaDesdeDate { get; set; }
        ...
        public string FechaDate { get; set; }
        ...
        public object Clone()
        {
            var contrato = (DetalleContratoModalDto)MemberwiseClone();
            return contrato;
        }
