...
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSesentaYTres') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSesentaYTres',63,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSesentaYCuatro') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSesentaYCuatro',64,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSesentaYCinco') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSesentaYCinco',65,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSesentaYSeis') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSesentaYSeis',66,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSesentaYSiete') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSesentaYSiete',67,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSesentaYOcho') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSesentaYOcho',68,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSesentaYNueve') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSesentaYNueve',69,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSetenta') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSetenta',70,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSetentaYUno') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSetentaYUno',71,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSetentaYDos') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSetentaYDos',72,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSetentaYTres') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSetentaYTres',73,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSetentaYCuatro') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSetentaYCuatro',74,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSetentaYCinco') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSetentaYCinco',75,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSetentaYSeis') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSetentaYSeis',76,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSetentaYSiete') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSetentaYSiete',77,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSetentaYOcho') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSetentaYOcho',78,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaSetentaYNueve') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaSetentaYNueve',79,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaOchenta') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaOchenta',80,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaOchentaYUno') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaOchentaYUno',81,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaOchentaYDos') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaOchentaYDos',82,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaOchentaYTres') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaOchentaYTres',83,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaOchentaYCuatro') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaOchentaYCuatro',84,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaOchentaYCinco') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaOchentaYCinco',85,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaOchentaYSeis') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaOchentaYSeis',86,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaOchentaYSiete') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaOchentaYSiete',87,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaOchentaYOcho') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaOchentaYOcho',88,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaOchentaYNueve') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaOchentaYNueve',89,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaNoventa') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaNoventa',90,1); END
IF NOT EXISTS (select 1 from Clausula where Discriminator = 'ClausulaNoventaYUno') BEGIN insert into Clausula(Discriminator, Orden, Estado) values ('ClausulaNoventaYUno',91,1); END
