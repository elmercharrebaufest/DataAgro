...
RiesgoComercialSap   varchar(255), Estado  varchar(255), Situacion  varchar(255),Faccop int, Calificacion int, GrupoDeCompras varchar(255), FechaAlta DATETIME)
 ...
 ,telefono4,ComercialAcargo,FechaUltimoContacto,RiesgoComercialSap,Estado,Situacion,Faccop, Calificacion, GrupoDeCompras, FechaAlta)
 select  
	p.ProveedorId, 
	p.CUIT as CUIT, 
