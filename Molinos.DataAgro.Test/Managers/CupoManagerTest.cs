...
namespace Molinos.DataAgro.Test.Managers
{
    ...
    public class CupoManagerTest
    {
        ...
        private Mock<IClienteStopV1Agent> clienteStopV1Agent;
        private Mock<IClienteStopV2Agent> clienteStopV2Agent;
        private Mock<Func<ICupoManager>> cupoManagerInj;
        ...
        public void SetUp()
        {
            ...
            clienteStopV1Agent = new Mock<IClienteStopV1Agent>();
            clienteStopV2Agent = new Mock<IClienteStopV2Agent>();
            cupoManagerInj = new Mock<Func<ICupoManager>>();

            ConfigurationManager.AppSettings["ValorPruebaSap"] = "1";
            ConfigurationManager.AppSettings["UrlBaseSTOP"] = "https://demo.ssta.gob.ar/turnos/";
        ...
        public void EliminarCupoTest()
        {
            ...
            clienteStopMock.Setup(x => x.EliminarCupo(It.IsAny<Cupo>(), null, null)).Returns(new Resultado { Errores = new List<ErrorMessage>() });
            repositorioMock.Setup(x => x.GuardarCambios());

            var result = target.EliminarCupo(1, "a", true);
            repositorioMock.Verify(x => x.Obtener<Cupo>(It.IsAny<int>()), Times.Once);
            clienteStopMock.Verify(x => x.EliminarCupo(It.IsAny<Cupo>(), null, null), Times.Once);
            repositorioMock.Verify(x => x.GuardarCambios(), Times.Once);
        ...
        public void EliminarCupoTestOk()
        {
            ...
            clienteStopMock.Setup(y => y.EliminarCupo(It.IsAny<Cupo>(), null, null)).Returns(new Resultado() { Errores = new List<ErrorMessage>() });
            ...
            clienteStopMock.Verify(y => y.EliminarCupo(It.IsAny<Cupo>(), null, null), Times.Once);
        ...
        //[Test]
        //public void ObtenerTokenStopTestOk()
        //{
        //    repositorioMock.Setup(y => y.Obtener(It.IsAny<Expression<Func<TokenStop, bool>>>(), It.IsAny<Expression<Func<TokenStop, string>>>()))
        //        .Returns("aaabbbbccc");
        //    var result = target.ObtenerTokenStop();

        //    repositorioMock.Verify(x => x.Obtener(It.IsAny<Expression<Func<TokenStop, bool>>>(), It.IsAny<Expression<Func<TokenStop, string>>>()), Times.Once);

        //    Assert.NotNull(result);
        //    Assert.AreEqual("aaabbbbccc", result);
        //}
        ...
        public void DevolverSugerenciasMasivoTest()
        {
            ...
            repositorioMock.Verify(x => x.Obtener(It.IsAny<Expression<Func<SugerenciaPorComercial, bool>>>()), Times.Once);
        ...
        [Test]
        public void ListarNegociosParaSolicitarCupo_ConNroContrato()
        {
            repositorioMock.Setup(y => y.Obtener(It.IsAny<Expression<Func<Negocio, bool>>>(), It.IsAny<Expression<Func<Negocio, NegocioParaSolicitarCupo>>>()))
                .Returns(new NegocioParaSolicitarCupo { ContratoSAP = "0002685378", ProveedorId = 1534, MaterialId = 3 });
            contratoKgPendienteAgent.Setup(x => x.Consultar(It.IsAny<List<ContratoKgPendiente>>()))
                .Returns(new List<ContratoKgPendiente> { new ContratoKgPendiente { ContratoSAP = "0002685378", KgPendiente = 60000, ContratoId = 1 } });
            repositorioMock.Setup(x => x.Listar(It.IsAny<Expression<Func<AdministracionCupo, bool>>>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<DirOrden>()))
                .Returns(new List<AdministracionCupo> { new AdministracionCupo { EstadoId = 1, NegocioId = 1 } });
            repositorioMock.Setup(x => x.Listar(It.IsAny<Expression<Func<Cupo, bool>>>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<DirOrden>()))
                .Returns(new List<Cupo> { new Cupo { EstadoCupoId = 1, NegocioId = 1 } });

            var result = target.ListarNegociosParaSolicitarCupo("0002685378", 1534, 3, 0);
            ...
            repositorioMock.Verify(x => x.Listar(It.IsAny<Expression<Func<AdministracionCupo, bool>>>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<DirOrden>()), Times.Once);
            repositorioMock.Verify(x => x.Listar(It.IsAny<Expression<Func<Cupo, bool>>>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<DirOrden>()), Times.Once);
            Assert.NotNull(result);
        }

        [Test]
        public void ListarNegociosParaSolicitarCupo_SinNroContrato()
        {
            repositorioMock.Setup(y => y.Listar(It.IsAny<Expression<Func<Negocio, NegocioParaSolicitarCupo>>>(), It.IsAny<Expression<Func<Negocio, bool>>>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<DirOrden>()))
                .Returns(new List<NegocioParaSolicitarCupo>() { new NegocioParaSolicitarCupo { ContratoSAP = "0002685378", ProveedorId = 1534, MaterialId = 3 } });
            contratoKgPendienteAgent.Setup(x => x.Consultar(It.IsAny<List<ContratoKgPendiente>>()))
                .Returns(new List<ContratoKgPendiente> { new ContratoKgPendiente { ContratoSAP = "0002685378", KgPendiente = 60000, ContratoId = 1 } });
            repositorioMock.Setup(x => x.Listar(It.IsAny<Expression<Func<AdministracionCupo, bool>>>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<DirOrden>()))
                .Returns(new List<AdministracionCupo> { new AdministracionCupo { EstadoId = 1, NegocioId = 1 } });
            ...
            var result = target.ListarNegociosParaSolicitarCupo(null, 1534, 3, 0);
