...
namespace Molinos.DataAgro.Test.Managers
{
    ...
    public class ReportesManagerTest
    {
        ...
        public void TraerPosicionComprasTest()
        {
            ...
            repositorioMock.Setup(y => y.Listar(It.IsAny<Expression<Func<Negocio, BasicoContrato>>>(), It.IsAny<Expression<Func<Negocio, bool>>>(), It.IsAny<int>(), It.IsAny<string>(), Entities.Helpers.DirOrden.Asc))
             .Returns(new List<BasicoContrato>() {
                 ...
                 new BasicoContrato { Fecha = fecha,EsFason=false, Id = 2, Precio = 1, Cantidad = 1, FechaDesde = fecha, FechaHasta = fecha1,TipoNegocioId=3,StandardDeCalidadId =1, Estado = 2 ,MaterialId=1,ContratoAcuerdoId = null,OcultarEnTablero=false},
                 new BasicoContrato { Fecha = fecha,EsFason=false, Id = 3, Precio = 1, Cantidad = 1, FechaDesde = fecha1, FechaHasta = fecha,TipoNegocioId=1, Estado = 2,MaterialId=1,StandardDeCalidadId=1,DestinoId=1,ContratoAcuerdoId= null,OcultarEnTablero=false },
                 new BasicoContrato { Fecha = fecha,EsFason=false, Id = 3, Precio = 1, Cantidad = 1, FechaDesde = fecha, FechaHasta = fecha1,TipoNegocioId=2, Estado = 2,MaterialId=1,StandardDeCalidadId=1,DestinoId=1,ContratoAcuerdoId= null,OcultarEnTablero=false },
                 new BasicoContrato { Fecha = fecha,EsFason=false, Id = 3, Precio = 1, Cantidad = 1, FechaDesde = fecha, FechaHasta = fecha2,TipoNegocioId=3, Estado = 2,MaterialId=1,StandardDeCalidadId=null,DestinoId=1,ContratoAcuerdoId= null,OcultarEnTablero=false },
                 new BasicoContrato { Fecha = fecha,EsFason=false, Id = 3, Precio = 1, Cantidad = 1, FechaDesde = fecha3, FechaHasta = fecha,TipoNegocioId=4, Estado = 2,MaterialId=1,StandardDeCalidadId=1,DestinoId=1,ContratoAcuerdoId= null,OcultarEnTablero=false },
                 new BasicoContrato { Fecha = fecha,EsFason=false, Id = 3, Precio = 1, Cantidad = 1, FechaDesde = fecha, FechaHasta = fecha,TipoNegocioId=5, Estado = 2,MaterialId=1,StandardDeCalidadId=1,DestinoId=1,ContratoAcuerdoId= null,OcultarEnTablero=false },
                 new BasicoContrato { Fecha = fecha,EsFason=false, Id = 3, Precio = 1, Cantidad = 1, FechaDesde = fecha, FechaHasta = fecha,TipoNegocioId=6, Estado = 2,MaterialId=1,StandardDeCalidadId=1,DestinoId=1,ContratoAcuerdoId= null,OcultarEnTablero=false },
                 new BasicoContrato { Fecha = fecha,EsFason=false, Id = 3, Precio = 1, Cantidad = 1, FechaDesde = fecha, FechaHasta = fecha,TipoNegocioId=1, Estado = 2,MaterialId=1,StandardDeCalidadId=1,DestinoId=1,ContratoAcuerdoId= null,OcultarEnTablero=false }
             });
        ...
        public void DetalleAgenteModalTestOk()
        {
            ...
            repositorioMock.Setup(y => y.Listar(It.IsAny<Expression<Func<AgenteCompra, DetalleAgenteDto>>>(),
                It.IsAny<Expression<Func<AgenteCompra, bool>>>(), It.IsAny<int>(), It.IsAny<string>(), Entities.Helpers.DirOrden.Asc))
                .Returns(new List<DetalleAgenteDto>() {
                    new DetalleAgenteDto {
                        Agente = "a",
                        Operador = "a",
                        Moneda = "A",
                        Comercial = "a",
            ...
            // Assert
            repositorioMock.Verify(x => x.Listar(It.IsAny<Expression<Func<AgenteCompra, DetalleAgenteDto>>>(),
                It.IsAny<Expression<Func<AgenteCompra, bool>>>(), It.IsAny<int>(), It.IsAny<string>(), Entities.Helpers.DirOrden.Asc), Times.Once);
            Assert.NotNull(result);
            //Assert.AreEqual(
