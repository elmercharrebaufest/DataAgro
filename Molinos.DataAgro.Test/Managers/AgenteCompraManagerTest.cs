...
namespace Molinos.DataAgro.Test.Managers
{
    ...
    public class AgenteCompraManagerTest
    {
        ...
        public void GrabarAgenteTestOk()
        {
            ...
            var agente = new AgenteCompra { Id = 1, Cantidad = 1, ComercialCreadorId = 1, ComercialId = 1, EstadoId = 1, MaterialId = 1, MonedaId = "1", OperadorId = 1, Fecha = fecha, Posicion = "1", Precio = 1, TipoAgenteCompraId = 1 };
        ...
        {
            var fecha = new DateTime(2019, 10, 01);
            var agente = new AgenteCompra { Id = 0, Cantidad = 1, ComercialCreadorId = 1, ComercialId = 1, EstadoId = 1, MaterialId = 1, MonedaId = "1", OperadorId = 1, Fecha = fecha, Posicion = "1", Precio = 1, TipoAgenteCompraId = 1 };
            repositorioMock.Setup(y => y.Listar(It.IsAny<Expression<Func<RangoPrecio, bool>>>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<DirOrden>()))
                            .Returns(new List<RangoPrecio>());
            repositorioMock.Setup(y => y.Obtener<AgenteCompra>(It.IsAny<int>()))
                            .Returns(new AgenteCompra());
