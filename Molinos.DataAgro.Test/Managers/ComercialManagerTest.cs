...
namespace Molinos.DataAgro.Test.Managers
{
    ...
    public class ComercialManagerTest
    {
        ...
        {
            repositorioMock.Setup(x => x.Listar(It.IsAny<Expression<Func<Comercial, ComercialIni>>>(), It.IsAny<Expression<Func<Comercial, bool>>>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<DirOrden>()))
            ...
            repositorioMock.Verify(x => x.Listar(It.IsAny<Expression<Func<Comercial, ComercialIni>>>(), It.IsAny<Expression<Func<Comercial, bool>>>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<DirOrden>()), Times.Once);
        ...
        public void ComercialPerteneceProveedorTest()
        {
            ...
            var resultado = target.ComercialPerteneceProveedor(new List<int>() { 1 }, 1, 1, new List<int>() { 1, 2 });
        ...
        {
            repositorioMock.Setup(x => x.Obtener(It.IsAny<Expression<Func<Comercial, bool>>>()))
                .Returns(new Comercial { ComercialId=1, IdActiveDirectory="a",PerfilId=1,});
            repositorioMock.Setup(x => x.Listar(It.IsAny<Expression<Func<Comercial, ComercialQry>>>(), It.IsAny<Expression<Func<Comercial, bool>>>(),It.IsAny<int>(), It.IsAny<string>(), It.IsAny<DirOrden>()))
        ...
        public void CadenaComercialesTest()
        {
            ...
            repositorioMock.Setup(x => x.Obtener<Comercial>(It.IsAny<int>()))
                .Returns(new Comercial { ComercialId=1, PerfilId=1});
        ...
        public void ListarCorredoresComercialTestNoCorredor()
        {
            repositorioMock.Setup(x => x.Obtener(It.IsAny<Expression<Func<Comercial, bool>>>(), It.IsAny<Expression<Func<Comercial, int>>>()))
                .Returns(1);
            var resultado = target.ListarCorredoresComercial(1);
        ...
        public void ListarCorredoresComercialTestCorredor()
        {
            ...
            var resultado = target.ListarCorredoresComercial(8);

            repositorioMock.Verify(x => x.Listar(It.IsAny<Expression<Func<Comercial, int>>>(), It.IsAny<Expression<Func<Comercial, bool>>>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<DirOrden>()), Times.Once);
        ...
        public void ListarComercialesPorPerfilTest()
        {
            ...
            var resultado = target.ListarComercialesPorPerfil((EnumPerfil)1);
