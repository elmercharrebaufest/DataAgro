...
namespace Molinos.DataAgro.Test.Controllers
{
    ...
    public class HedgeControllerTest
    {
        ...
        public void CerrarDiaTest()
        {
            ...
            reportesManagerMock.Setup(x => x.TraerHedgeObjetivo(It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<List<int>>(), It.IsAny<bool>())).Returns(new HedgeCargaObjetivoDto());
            reportesManagerMock.Setup(x => x.TraerTcPromedio(It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<List<int>>(), It.IsAny<bool>())).Returns(new HedgeTCPromedioDto());
            reportesManagerMock.Setup(x => x.PosicionPorMaterial(It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<bool>())).Returns(new List<ExcelPosicionMaterialDto>());
            reportesManagerMock.Setup(x => x.TraerPricingCampania(It.IsAny<DateTime>(), It.IsAny<DateTime>(), It.IsAny<List<int>>(), It.IsAny<int>(), It.IsAny<bool>())).Returns(new List<PricingCampaniaDto>());
