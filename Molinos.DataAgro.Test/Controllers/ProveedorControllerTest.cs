...
namespace Molinos.DataAgro.Test.Controllers
{
    ...
    public class ProveedorControllerTest
    {
        ...
        public void TraerMaterialPorCampañaTest()
        {
            ...
            var a = serializer.Serialize(result);
            Assert.AreEqual(
                "{\"ContentEncoding\":null,\"ContentType\":null,\"Data\":[{\"MaterialId\":1,\"Codigo\":null,\"Descripcion\":\"A\",\"CampañaId\":1,\"Campana\":null}],\"JsonRequestBehavior\":1,\"MaxJsonLength\":2147483647,\"RecursionLimit\":null}",
                a);
        }
        [Test]
