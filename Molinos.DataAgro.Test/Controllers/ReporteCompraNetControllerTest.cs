...
namespace Molinos.DataAgro.Test.Controllers
{
    ...
    public class ReporteCompraNetControllerTest
    {
        ...
        public void PartialReporteCompraNetTest()
        {
            ...
            reportesManagerMock.Setup(x => x.TraerToneladasSojaEPA(fecha, fecha, 0)).Returns(new ReporteSojaEPADto());
            reportesManagerMock.Setup(x => x.TraerPosicionCompras(fecha, fecha, new List<int>() { 1, 2, 3, 4, 5 }, 0, false, It.IsAny<bool>())).Returns(new List<PosicionComprasDto>());
            reportesManagerMock.Setup(x => x.TraerMonedaCantidad(fecha, fecha, new List<int>() { 1, 2, 3, 4, 5 }, 0, It.IsAny<bool>())).Returns(new List<PrecioCantidadDto>());
            ...
            reportesManagerMock.Setup(x => x.TraerTcPromedio(fecha, fecha, new List<int>() { 1, 2, 3, 4, 5 }, It.IsAny<bool>())).Returns(new HedgeTCPromedioDto());
            reportesManagerMock.Setup(x => x.TraerHedgeObjetivo(fecha, fecha, new List<int>() { 1, 2, 3, 4, 5 }, It.IsAny<bool>())).Returns(new HedgeCargaObjetivoDto());
        ...
        public void DetalleExcelTest()
        {
            ...
            reportesManagerMock.Setup(x => x.DetallePosicion(1, 10, 2018, fecha, fecha, null, 0, It.IsAny<bool>())).Returns(new ExcelDetallePosicionDto()
            {
        ...
        public void DetalleExcelModalTest()
        {
            ...
            reportesManagerMock.Setup(x => x.DetallePosicionModal(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), null, 0, It.IsAny<bool>())).Returns("");
            var result = target.DetalleExcelModal(2, 2018, 1, "26-10-2018", "26-10-2018", 2, "0");
            Assert.NotNull(result);
            var a = serializer.Serialize(result);

            reportesManagerMock.Verify(x => x.DetallePosicionModal(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<DateTime>(), It.IsAny<DateTime>(), null, 0, It.IsAny<bool>()), Times.Once);
            Assert.AreEqual(
        ...
        public void DetalleIdsModal()
        {
            var fecha = new DateTime(2018, 10, 26);
            HttpContext.Current.Session["equipo"] = new List<int> { 1, 2 };
            reportesManagerMock.Setup(x => x.DetallePosicionModalIds(It.IsAny<List<int>>(), It.IsAny<string>(), It.IsAny<int?>())).Returns("");
            var result = target.DetalleIdsModal(new List<int> { 1 }, "",null);
            Assert.NotNull(result);
            var a = serializer.Serialize(result);

            reportesManagerMock.Verify(x => x.DetallePosicionModalIds(It.IsAny<List<int>>(), It.IsAny<string>(), It.IsAny<int?>()), Times.Once);
            Assert.AreEqual(
                "{\"ContentEncoding\":null,\"ContentType\":null,\"Data\":\"\",\"JsonRequestBehavior\":0,\"MaxJsonLength\":null,\"RecursionLimit\":null}",
                a);
        }
