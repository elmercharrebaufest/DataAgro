...
namespace Molinos.DataAgro.Test.Controllers
{
    ...
    public class CompraNetControllerTest
    {
        ...
        public void GrabarContratoConComercialTest()
        {
            ...
            contratoManagerMock.Setup(x => x.GrabarContrato(contrato, null)).Returns(new GrabarContratoResult { ContratoId = 1, Errores = new List<ErrorMessage>() });
        ...
        public void ReenviarMailsTest()
        {
            ...
            Assert.AreEqual(
                 "{\"ContentEncoding\":null,\"ContentType\":null,\"Data\":{\"ContratoId\":null,\"ListaCupos\":[],\"Errores\":[],\"ListaErrores\":[],\"HayError\":false,\"HayErrores\":false},\"JsonRequestBehavior\":1,\"MaxJsonLength\":2147483647,\"RecursionLimit\":null}",
                 a);
        }
        [Test]
        ...
        public void ObtenerDatosCompraNetTest()
        {
            ...
            Assert.AreEqual(
                "{\"ContentEncoding\":null,\"ContentType\":null,\"Data\":{\"ProveedorId\":1,\"LocalidadId\":1,\"Localidad\":\"a\",\"ProvinciaId\":1,\"Provincia\":\"b\",\"ClasificacionCompraNetId\":1,\"Consignatario\":true,\"BoletoCompraNetId\":1,\"BolsaCompraNetId\":1,\"ComisionPorcentaje\":null,\"PlanCanje\":null,\"RazonSocialComisionista\":null,\"ComisionistaId\":null},\"JsonRequestBehavior\":1,\"MaxJsonLength\":2147483647,\"RecursionLimit\":null}",
                a);
        }
        [Test]
        ...
        */
        ...
        public void ValidarModificarFinalizadoTest()
        {
            ...
            Assert.AreEqual(
                "{\"ContentEncoding\":null,\"ContentType\":null,\"Data\":{\"ContratoSap\":null,\"Status\":\"OK\",\"NumeroSio\":0,\"Mensaje\":null,\"FechaConfirmadoSAP\":null},\"JsonRequestBehavior\":1,\"MaxJsonLength\":null,\"RecursionLimit\":null}",
                a);
        }
