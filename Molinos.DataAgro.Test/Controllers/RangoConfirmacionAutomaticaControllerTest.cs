...
namespace Molinos.DataAgro.Test.Controllers
{
    ...
    public class RangoConfirmacionAutomaticaControllerTest
    {
        ...
        public void InicializarRangoPrecioTest()
        {
            ...
            Assert.AreEqual(
                "{\"ContentEncoding\":null,\"ContentType\":null,\"Data\":{\"Datos\":{\"Material\":[{\"MaterialId\":1,\"Descripcion\":\"A\",\"Codigo\":null,\"Campaña\":null}],\"Moneda\":[{\"MonedaId\":\"A\",\"Descripcion\":\"A\"}],\"Zona\":null},\"RangoConfirmacion\":{\"Id\":0,\"PrecioMinimo\":0,\"PrecioMaximo\":0,\"MaterialId\":0,\"MonedaId\":null,\"FechaDesde\":\"\\/Date(-62135586000000)\\/\",\"FechaHasta\":\"\\/Date(-62135586000000)\\/\",\"ZonaId\":null,\"Cantidad\":0,\"DesdeMes\":0,\"DesdeAnio\":0,\"HastaMes\":0,\"HastaAnio\":0,\"Material\":null,\"Moneda\":null,\"Zona\":null},\"Errores\":[],\"ListaErrores\":[],\"HayError\":false,\"HayErrores\":false},\"JsonRequestBehavior\":1,\"MaxJsonLength\":2147483647,\"RecursionLimit\":null}",
                a);
        }
        ...
        {
            rangoManagerMock.Setup(x => x.TraerTodoRango()).Returns(new ResultIniRangoConfirmacionAutomatica
            {
            ...
            var a = serializer.Serialize(result);
            Assert.AreEqual(
                "{\"ContentEncoding\":null,\"ContentType\":null,\"Data\":{\"Datos\":[{\"Id\":1,\"PrecioMinimo\":1,\"PrecioMaximo\":1,\"Material\":\"A\",\"Moneda\":\"A\",\"FechaDesde\":\"\\/Date(-62135586000000)\\/\",\"FechaHasta\":\"\\/Date(-62135586000000)\\/\",\"ZonaId\":0,\"Zona\":null,\"Cantidad\":0,\"EntregaDesde\":null,\"EntregaHasta\":null}],\"Errores\":[],\"ListaErrores\":[],\"HayError\":false,\"HayErrores\":false},\"JsonRequestBehavior\":1,\"MaxJsonLength\":2147483647,\"RecursionLimit\":null}",
                a);
        }
        ...
        public void RangoComboTest()
        {
            ...
            var a = serializer.Serialize(result);
            Assert.AreEqual(
                "{\"ContentEncoding\":null,\"ContentType\":null,\"Data\":{\"Rango\":{\"Id\":1,\"PrecioMinimo\":1,\"PrecioMaximo\":1,\"Material\":null,\"MaterialId\":1,\"Moneda\":null,\"MonedaId\":\"A\",\"FechaDesde\":\"\\/Date(-62135586000000)\\/\",\"FechaHasta\":\"\\/Date(-62135586000000)\\/\",\"ZonaId\":0,\"Zona\":null,\"Cantidad\":0,\"DesdeMes\":0,\"DesdeAnio\":0,\"HastaMes\":0,\"HastaAnio\":0},\"Errores\":[],\"ListaErrores\":[],\"HayError\":false,\"HayErrores\":false},\"JsonRequestBehavior\":1,\"MaxJsonLength\":2147483647,\"RecursionLimit\":null}",
                a);
        }
        [Test]
