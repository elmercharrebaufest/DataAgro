...
namespace WebDataAgro.JobRegistration
{
    public static class HangfireJobRegistry
    {
        public static void Register()
        {
            ...
            RecurringJob.AddOrUpdate<IActualizarEstadoBoletosConfirmaHangfireJob>("ActualizarEstadoBoletosConfirmaHangfireJob", s => s.Execute(), "*/30 * * * *", new RecurringJobOptions {TimeZone = TimeZoneInfo.Local });
