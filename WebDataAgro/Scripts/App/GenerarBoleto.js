    ...
    function inicializarGrilla() {
        ...
        state.grid = $grid.kendoGrid({
            ...
            columns: [
                ...
                { field: "Estado_Version", title: "Estado Boleto en Data", type: "string", headerAttributes: { title: "Estado Boleto en Data" } },
                { field: "TipoNegocio", title: "Tipo de contrato", type: "string", headerAttributes: { title: "Tipo de contrato" } },
                { field: "TipoBoleto", title: "Tipo de Boleto", type: "string", headerAttributes: { title: "Tipo de Boleto" } },
                { field: "Observacion", title: "Observaciones", headerAttributes: { title: "Observaciones" }, sortable: false, filterable: false },
