...
//function visualizacionRowSimple(dato, idDiv, idText) {  //se usaba s�lo en visualizacionRowSimple("aperturaBasisDivVisualizar", "visualizar_aperturaBasis");
...
function visualizacionRowSimple(div, span) {
    if ($("#" + span).text() === "null") {
        $("#" + div).hide();
    } else {
        $("#" + div).show();
...
function ModalPreAnular(id, fijacionId, proveedor, tipoNegocio, kilos) {
    ...
    //if (kilos && kilos > 0) {
    //    $("#espaciolineas").html("Usted est� intentando preanular una <b>Fijaci�n Virtual</b> de " + proveedor +
    //        " con " + kendo.toString(kilos, "n") + " kg de saldo sobre " + + " kg." +
    //        "<br>Si prosigue se har� una anulaci�n parcial."+
    //        "<br>�Desea proseguir?"
    //    );
...
$("#copiar-cupos-btn").on("click", function () {
    ...
    // Copiar el cupoSAP al portapapeles y cambiar �cono del bot�n
