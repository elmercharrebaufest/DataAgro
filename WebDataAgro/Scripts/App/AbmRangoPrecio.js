...
function InicializarCombos() {
    ...
    MSExecuteURLOnServerAsync('/RangoPrecio/Inicializar', funcReturn, '');
}
...
function InicializarBusquedaInicial() {
    ...
    MSExecuteURLOnServerAsync('/RangoPrecio/Buscar', funcReturn, '');
}
...
function UpdateViewModel(model) {
    ...
    viewModel.set("RangoPrecio", rango);
}
...
function Agregar() {
    ...
    var result = MSExecuteURLOnServer('/RangoPrecio/Cancelar');
...
function Modificar() {
    ...
    if (data.Id > 0) {
        var datosRango = MSExecuteOnServer('/RangoPrecio/RangoCombo', param);
        ...
        if (datosRango != null) {
            if (ExistsErrorMessages(datosRango.Errores)) {
                ...
                viewModel.set("RangoPrecio", datosRango.Rango);
            }
        }
    }

    var result = MSExecuteOnServer('/RangoPrecio/Aplicar', param);
...
function EjecutarEliminar() {
    ...
    var result = MSExecuteOnServer('/RangoPrecio/Eliminar', param);
...
function Grabar() {
    ...
    var datos = {
        "Id": viewModel.get("RangoPrecio.Id"),
    ...
    var result = MSExecuteOnServer('/RangoPrecio/Grabar', datos);
