...
var ControlBoletos = (function () {
  ...
  return {
    ...
    mostrarVistaCartas: function () {
      mostrarMensaje(
        "Información",
        "La vista de cartas estará disponible en una próxima versión",
        "info",
      );
    ...
    generarBotonesAccion: function (data) {
      ...
      if (data.ControlDeBoletosEstado === "Pendiente") {
        botones.push(
      ...
      if (data.ControlDeBoletosEstado === "En Proceso") {
        botones.push(
