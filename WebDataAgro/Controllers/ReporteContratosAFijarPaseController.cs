...
namespace WebDataAgro.Controllers
{
    ...
    public class ReporteContratosAFijarPaseController : Controller
    {
        ...
        public ReporteContratosAFijarPaseController(IProveedorManager oProveedorManager, IContratoManager ocontratoManager, IComercialManager oComercialManager, IProvinciaManager oProvinciaManager, ILocalidadManager oLocalidadManager,
        ...
        [Autorizacion(PermisosDataAgro.VisualizarReporteContratosAFijarPase)]
        ...
        public ActionResult BuscaDatosTabla(DataSourceRequest filtro)
        {
            ...
            DataSourceResult model = mobjContratoManager.TraerContratosReporteAFijarPase(filtro,equipo);
