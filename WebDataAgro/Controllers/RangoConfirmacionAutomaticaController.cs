...
namespace WebDataAgro.Controllers
{
    public class RangoConfirmacionAutomaticaController : Controller
    {
        ...
        public ActionResult Grabar(RangoConfirmacionAutomatica oRango)
        {
            ...
            {
                model.Rango = new RangoConfirmacionAutomaticaDto { Id = oRango.Id, PrecioMinimo = oRango.PrecioMinimo, PrecioMaximo = oRango.PrecioMaximo, MaterialId = oRango.MaterialId, MonedaId = oRango.MonedaId};
            }
            else
            {
